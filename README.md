...
Open http://localhost:3000?code=AMY823 to explore a bridesmaid experience. Swap the code (`RAJ507`, `MIA242`, `JON110`, `LIV912`) to see tailored itineraries, travel helpers, and registry suggestions. Without a code, the site defaults to a visitor view.
...
- **Smart itinerary** filters relevant events, surfaces shuttle times, and calculates “leave by” reminders per guest.
- **Travel, registry, and entertainment modules** adapt content for out-of-town guests, budget hints, and interests.
